...
setup(
    ...
    description="Helper library for the Adafruit RGB Matrix Shield + Metro M4 Airlift Lite.",
    ...
    keywords="adafruit blinka circuitpython micropython matrixportal rgb matrix airlift lite "
    "metro rgbmatrix",
